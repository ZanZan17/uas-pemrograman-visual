...
type
  ...
  TTfrmUpdateCategory = class(TForm)
...
var
  TfrmUpdateCategory: TTfrmUpdateCategory;
  id_kategori: Integer;
...
procedure TTfrmUpdateCategory.setId(id: Integer);
begin
  id_kategori := id;
end;

procedure TTfrmUpdateCategory.setNama;
begin
  AmbilKategori(id_kategori);
end;

procedure TTfrmUpdateCategory.AmbilKategori(id_kategori: Integer);
var
  nama: string;
begin
...
procedure TTfrmUpdateCategory.FormCreate(Sender: TObject);
begin
end;

procedure TTfrmUpdateCategory.BtnUpdateKategoriClick(Sender: TObject);
begin
  try
    with SQLQueryKategori do
    begin
