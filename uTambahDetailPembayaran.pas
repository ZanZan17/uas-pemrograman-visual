...
type
  ...
  { TTfrmTambahDetailPembayaran }

  TTfrmTambahDetailPembayaran = class(TForm)
...
var
  TfrmTambahDetailPembayaran: TTfrmTambahDetailPembayaran;

implementation

{$R *.lfm}

procedure TTfrmTambahDetailPembayaran.logicTransaksi(jumlahBeli: string; idBarang: string; nama_customer: string);
var
...
procedure TTfrmTambahDetailPembayaran.ambilDataBarang;
begin
  try
    with SQLQueryPilihBarang do
    begin
...
procedure TTfrmTambahDetailPembayaran.SetCustomer(const ACustomer: string);
begin
  customer := ACustomer;
end;

procedure TTfrmTambahDetailPembayaran.FormCreate(Sender: TObject);
begin
  SQLQueryPilihBarang.Open;
end;

procedure TTfrmTambahDetailPembayaran.DBLookupBarangChange(Sender: TObject);
begin

end;

procedure TTfrmTambahDetailPembayaran.BTambahDetailTransaksiClick(Sender: TObject);
var
  id: string;
begin
