...
uses
  ...
  sign_in, uDataBarang, transaction, uReport, uDataKategoriBarang, uTambahTransaksi;
  ...
  try
    ...
    begin
      ...
      begin
         ...
         EnableMenu(Produk.Items);
         LNS.Caption := 'STARGAZE ' + UpperCase(Fusername);
         LNS.Visible:= true;
         if FRole <> 1 then
         begin
