...
procedure TTfrmLapor.BCariClick(Sender: TObject);
begin
  with SQLQuery1 do
  begin
     Close;
...
procedure TTfrmLapor.BLaporanClick(Sender: TObject);
var
  s: string;
begin
  try
...
procedure TTfrmLapor.BResetClick(Sender: TObject);
begin
  with SQLQuery1 do
  begin
     Close;
...
procedure TTfrmLapor.ECariChange(Sender: TObject);
begin

end;

procedure TTfrmLapor.Label1Click(Sender: TObject);
begin
