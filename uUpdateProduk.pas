...
var
  TfrmUpdateProduk: TTfrmUpdateProduk;
...
{ TTfrmUpdateProduk }
procedure TTfrmUpdateProduk.BSimpanClick(Sender: TObject);
begin
  try
    with SQLQuery2 do
    begin
...
procedure TTfrmUpdateProduk.DBLookupIdChange(Sender: TObject);
var
  id: string;
begin
  try
...
procedure TTfrmUpdateProduk.FormClose(Sender: TObject;
...
procedure TTfrmUpdateProduk.FormCreate(Sender: TObject);
begin
  SQLQuery1.Open;
end;

procedure TTfrmUpdateProduk.Label7Click(Sender: TObject);
begin
