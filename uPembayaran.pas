...
var
  TfrmPembayaran: TTfrmPembayaran;

implementation

{$R *.lfm}

procedure TTfrmPembayaran.CariData(customer: string; SQ: TSQLQuery);
begin
   try
...
procedure TTfrmPembayaran.AmbilDataDetailTransaksi;
begin
with SQLQuery1 do
  begin
    Close;
...
procedure TTfrmPembayaran.FormCreate(Sender: TObject);
begin
     AmbilDataDetailTransaksi;
     AmbilDataTransaksi;
end;

procedure TTfrmPembayaran.BCariClick(Sender: TObject);
begin
     CariData(ECari.Text, SQLQuery1);
     CariData(ECari.Text, SQLQuery2);
end;

procedure TTfrmPembayaran.BResetClick(Sender: TObject);
begin
    AmbilDataDetailTransaksi;
    AmbilDataTransaksi;
    ECari.Text := '';
...
procedure TTfrmPembayaran.DBNavigator1Click(Sender: TObject;
...
procedure TTfrmPembayaran.AmbilDataTransaksi;
begin
with SQLQuery2 do
  begin
    Close;
